...
import 'package:mrs/config/palette.dart';
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  Container buildSignupSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(Icons.add, "User Name",
              false, false),
          buildTextField(
              Icons.add, "email", false, true),
          buildTextField(
              Icons.add, "password", true, false),
          Padding(
